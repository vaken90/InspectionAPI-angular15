...
import { InspectionsApiService } from 'src/app/inspections-api.service';

@Component({
  selector: 'app-show-inspections',
  templateUrl: './show-inspections.component.html',
  styleUrls: ['./show-inspections.component.css']
})
export class ShowInspectionsComponent implements OnInit {
  ...
  constructor(private service: InspectionsApiService) { }
